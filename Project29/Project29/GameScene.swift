...
//  Project29
//
//  Created by Lorenzo Pesci on 16/09/2020.
...
class GameScene: SKScene {
  ...
  // create an instance of the GameViewController
  ...
  override func didMove(to view: SKView) {
    ...
    // create players
    createPlayers()
    // assign self to be the delegate of your scene's physics world so that you can get notified of collisions
    physicsWorld.contactDelegate = self
  }
  
  /// A method that will create a building and add it to the scene
